...
page_title: "stripe_plans Resource - stripe"
subcategory: ""
description: |-
  
---

# stripe_plans (Resource)
...
- `transform_usage` (Map of String) Apply a transformation to the reported usage or set quantity before computing the billed price. Cannot be combined with `tiers`.
